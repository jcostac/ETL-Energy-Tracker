...
class I3Extractor:
    ...
    def extract_data_for_all_markets(self, fecha_inicio: Optional[str] = None, fecha_fin: Optional[str] = None, mercados_lst: Optional[list[str]] = None) -> dict:
        ...
        Parameters:
            fecha_inicio (Optional[str]): Start date for extraction in 'YYYY-MM-DD' format. If not provided, defaults to 1 day ago.
            fecha_fin (Optional[str]): End date for extraction in 'YYYY-MM-DD' format. If not provided, defaults to 1 day ago.
