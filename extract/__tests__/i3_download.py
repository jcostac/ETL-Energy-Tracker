...
def test_i3_download_multiple_days():
    ...
    try:
        ...
        overall_success, status_details = i3_volumenes_extractor.extract_data_for_all_markets(fecha_inicio_carga="2024-12-01", fecha_fin_carga="2024-12-02", mercados_lst=["intra"])
        breakpoint()

        assert overall_success == True, "i3 multiple days download failed"
