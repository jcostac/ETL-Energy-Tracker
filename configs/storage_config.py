...
VALID_DATASET_TYPES = ['precios_esios', 'volumenes_i90', 'volumenes_i3', 'ingresos', 'precios_i90', 'volumenes_omie', 'curtailments_i90', 'curtailments_i3', 'ingresos_diferencias']
