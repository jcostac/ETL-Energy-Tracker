...
def test_multiple_day_volumenes():
    ...
    result = transformer.transform_data_for_all_markets(fecha_inicio="2024-12-01", fecha_fin="2024-12-02", mercados_lst=["intra"])
...
def test_single_day_volumenes():
    ...
    """
    transformer = TransformadorI3()
    result = transformer.transform_data_for_all_markets(fecha_inicio="2024-12-01", fecha_fin="2024-12-01")
    result_status = result["status"]
