...
class DebugI90Transform:
    ...
    def debug_transform_data_for_all_markets(self, fecha_inicio, fecha_fin):
        """
        ...
        result = transformer.transform_data_for_all_markets(fecha_inicio=fecha_inicio, fecha_fin=fecha_fin, dataset_type= "volumenes_i90", mercados_lst=["secundaria"])
...
if __name__ == "__main__":
    ...
    debugger.debug_transform_data_for_all_markets("2025-01-01", "2025-01-01")
