...
class TestI3Transform(unittest.TestCase):
    ...
    def test_specific_day_volumenes(self):
        """
        Test the transformation of "volumenes_i3" data across multiple days for all markets.
        """
        transformer = TransformadorI3()
        result = transformer.transform_data_for_all_markets(fecha_inicio="2024-10-27", fecha_fin="2024-10-27", mercados_lst=["secundaria"])
